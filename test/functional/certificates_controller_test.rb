...
class CertificatesControllerTest < ActionController::TestCase
  ...
  test "should create certificate" do
    assert_difference('Certificate.count') do
      post :create, certificate: { date_completed: @certificate.date_completed, institution: @certificate.institution, name: @certificate.name }
    end
  ...
  test "should update certificate" do
    put :update, id: @certificate, certificate: { date_completed: @certificate.date_completed, institution: @certificate.institution, name: @certificate.name }
    assert_redirected_to certificate_path(assigns(:certificate))
  end
